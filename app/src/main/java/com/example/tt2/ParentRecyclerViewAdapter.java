...
public class ParentRecyclerViewAdapter extends RecyclerView.Adapter<ParentRecyclerViewAdapter.MyViewHolder> {
    ArrayList<com.example.tt2.ChildModel> arrayList;
    ArrayList<com.example.tt2.ParentModel> parentModelArrayList;
    Context context;
    SharedPreferences sharedpreferences;
    SharedPreferences.Editor editor;

    public ParentRecyclerViewAdapter(ArrayList<com.example.tt2.ParentModel> parentModelArrayList, com.example.tt2.MainActivity mainActivity) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        com.example.tt2.ParentModel artist = parentModelArrayList.get(position);
        ...
        com.example.tt2.ChildRecyclerViewAdapter childRecyclerViewAdapter = new com.example.tt2.ChildRecyclerViewAdapter(arrayList, holder.childRecyclerView.getContext());
        ...
        for(String album : albums){
            ...
            arrayList.add(new com.example.tt2.ChildModel(artist.getArtist(), album, albumImage));
        }
    }
