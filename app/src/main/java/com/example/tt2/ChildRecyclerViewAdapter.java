...
public class ChildRecyclerViewAdapter extends RecyclerView.Adapter<ChildRecyclerViewAdapter.MyViewHolder> {
    ArrayList<com.example.tt2.ChildModel> childModelArrayList;
    Context context;
    SharedPreferences sharedpreferences;
    SharedPreferences.Editor editor;

    public ChildRecyclerViewAdapter(ArrayList<com.example.tt2.ChildModel> childModelArrayList, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder  holder, int position) {
        com.example.tt2.ChildModel albumDetails = childModelArrayList.get(position);
        ...
        holder.itemView.setOnClickListener(view -> {
            com.example.tt2.ChildModel currentItem = childModelArrayList.get(holder.getAdapterPosition());
